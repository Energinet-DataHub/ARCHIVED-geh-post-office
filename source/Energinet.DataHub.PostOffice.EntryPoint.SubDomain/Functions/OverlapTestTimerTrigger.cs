...
namespace Energinet.DataHub.PostOffice.EntryPoint.SubDomain.Functions
{
    public class OverlapTestTimerTrigger
    {
        ...
        private readonly IDataAvailableNotificationRepositoryContainer _container;

        public OverlapTestTimerTrigger(ILogger<OverlapTestTimerTrigger> logger, IDataAvailableNotificationRepositoryContainer container)
        {
            _logger = logger;
