...
{
    [Fact]
    public async Task WasReceivedPreviously_NewNotification_ReturnsFalse()
    {
        // Arrange
        ...
        // Act
        var result = await dataAvailableIdempotencyService.WasReceivedPreviouslyAsync(
            notification,
            cosmosCabinetDrawer);
    ...
    [Fact]
    public async Task WasReceivedPreviously_SameNotification_ReturnsTrue()
    {
        // Arrange
        await using var host = await SubDomainIntegrationTestHost.InitializeAsync();
        var scope = host.BeginScope();
        ...
        await dataAvailableIdempotencyService.WasReceivedPreviouslyAsync(
            notification,
            cosmosCabinetDrawer);
    ...
    [Fact]
    public async Task WasReceivedPreviously_SameNotificationNotInDrawer_ReturnsFalse()
    {
        // Arrange
        await using var host = await SubDomainIntegrationTestHost.InitializeAsync();
        var scope = host.BeginScope();
    ...
    [Fact]
    public async Task WasReceivedPreviously_SameNotificationInDifferentDrawer_ReturnsTrue()
    {
        // Arrange
        await using var host = await SubDomainIntegrationTestHost.InitializeAsync();
        var scope = host.BeginScope();
    ...
    [Fact]
    public async Task WasReceivedPreviously_SameNotificationDifferentContent_ThrowsException()
    {
        // Arrange
        await using var host = await SubDomainIntegrationTestHost.InitializeAsync();
        var scope = host.BeginScope();
        ...
        // Assert
        await Assert.ThrowsAsync<ValidationException>(() => dataAvailableIdempotencyService.WasReceivedPreviouslyAsync(
             sameIdDifferentContent,
             cosmosCabinetDrawer));
    }

    [Fact]
    public async Task WasReceivedPreviously_OldIdempotency_ShouldNotFail()
    {
        // Arrange
        await using var host = await SubDomainIntegrationTestHost.InitializeAsync();
        var scope = host.BeginScope();
