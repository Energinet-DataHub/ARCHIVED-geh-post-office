...
internal class CimBoolValueElement : ICimValueElement
{
    private bool _value;

    public CimBoolValueElement(string key, ReadOnlyMemory<char> value)
    {
        Key = key;
        _value = bool.Parse(value.Span);
    }
    ...
    public void WriteJson(Utf8JsonWriter jsonWriter)
    {
        ...
        jsonWriter.WriteBoolean(Key.AsSpan(), _value);
    }
