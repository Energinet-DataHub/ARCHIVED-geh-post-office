...
internal class CimStringValueElement : ICimValueElement
{
    private ReadOnlyMemory<char> _value;

    public CimStringValueElement(string key, ReadOnlyMemory<char> value)
    {
        Key = key;
        _value = value;
    }
    ...
    public void WriteJson(Utf8JsonWriter jsonWriter)
    {
        ...
        jsonWriter.WriteString(Key.AsSpan(), _value.Span);
    }
