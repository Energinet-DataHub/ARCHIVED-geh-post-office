...
{
    public RSM033ConfirmRequestChangePricelist(RecyclableMemoryStreamManager manager, Stream xmlData)
    ...
    private void ReadConfirmRequestChangePriceList()
    {
        ...
        var activityArray = rootElement.AddArray(ElementNames.Root.MktActivityRecordElement, 3, 10);
        do
        {
