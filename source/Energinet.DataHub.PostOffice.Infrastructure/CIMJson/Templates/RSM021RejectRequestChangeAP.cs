...
{
    public RSM021RejectRequestChangeAP(RecyclableMemoryStreamManager manager, Stream xmlData)
    ...
    private void ReadRejectRequestChangeAccountingPointCharacteristics()
    {
        ...
        var activityArray = rootElement.AddArray(ElementNames.Root.MktActivityRecordElement, 5, 10);
        do
        {
